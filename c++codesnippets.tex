...
using std::string;(*\index{\texttt{std}}*)(*\index{Strings!\texttt{string}}*)

// use (*cin*), (*cout*) instead of (*std::cin*), (*std::cout*)
using std::cin;(*\index{\texttt{cin}}*)(*\index{\texttt{std}}*)
using std::cout;(*\index{\texttt{cout}}*)(*\index{\texttt{std}}*)
\end{lstlisting}
\begin{enumerate}
...
\end{enumerate}
\begin{lstlisting}
using namespace std;(*\index{\textbf{namespace}}*)(*\index{\texttt{std}}*)
\end{lstlisting}
\begin{enumerate}
...
using pchar = char*; // (*pchar*) means (*char$\ast$*)(*\index{\textbf{char}}*)
\end{lstlisting}
%
% Random numbers
%
...
for (auto x : arr)(*\index{\textbf{auto}}*)(*\index{range-for-loop}*)
  cout << x;(*\index{Arrays!printing elements of an array}*)(*\index{\texttt{cout}}*)
\end{lstlisting}
%
% Pointers
%
...
\end{lstlisting}
\begin{enumerate}
\item[$\Rightarrow$] \texttt{unique\_ptr}:\index{Pointers!\texttt{unique\_ptr}}
...
{
    unique_ptr<MyVector<int>*> p { new MyVector<int>};(*\index{\textbf{new}}*)(*\index{\texttt{unique\_ptr}}*)
    /* ... */
...
cin >> number >> ch;(*\index{Input-output streams!reading from the keyboard}*)(*\index{\texttt{cin}}*)

// write on standard output (display)
cout << number << " " <<  ch << endl;(*\index{Input-output streams!writing to the screen}*)(*\index{\texttt{cout}}*)
...
cout << showbase;(*\index{Input-output streams!integer format manipulators!show the base}*)(*\index{\texttt{cout}}*)(*\index{\texttt{cout}!\texttt{showbase}}*)
cout << dec << 1974 << endl;(*\index{Input-output streams!integer format manipulators!decimal}*)(*\index{\texttt{cout}!\texttt{dec}}*)
cout << oct << 1974 << endl;(*\index{Input-output streams!integer format manipulators!otctal}*)(*\index{\texttt{cout}!\texttt{oct}}*)
cout << hex << 1974 << endl;(*\index{Input-output streams!integer format manipulators!hexadecimal}*)(*\index{\texttt{cout}!\texttt{hex}}*)
cout << noshowbase;(*\index{Input-output streams!integer format manipulators!don't show the base}*)(*\index{\texttt{cout}!\texttt{noshowbase}}*)
...
// of all the flags
cin.unsetf(ios::dec);(*\index{\texttt{cin}!\texttt{unset}}*)(*\index{\texttt{cin}!\texttt{unset}!\texttt{ios::dec}}*)
cin.unsetf(ios::oct);(*\index{\texttt{cin}!\texttt{unset}!\texttt{ios::oct}}*)
cin.unsetf(ios::hex);(*\index{\texttt{cin}!\texttt{unset}!\texttt{ios::hex}}*)

//  now (*val*) can be inserted in any format
cin >> val;(*\index{\texttt{cin}}*)
\end{lstlisting}
\begin{enumerate}
...
cout << defaultfloat << 1023.984;(*\index{Input-output streams!floating point format manipulators!default float notation}*)(*\index{\texttt{cout}!\texttt{defaultfloat}}*)
cout << fixed << 1023.984;(*\index{Input-output streams!floating point format manipulators!fixed notation}*)(*\index{\texttt{cout}!\texttt{fixed}}*)
cout << scientific << 1023.984;(*\index{Input-output streams!floating point format manipulators!scientific notation}*)(*\index{\texttt{cout}!\texttt{scientific}}*)

// set precision
cout << setprecision(2) << 1023.984;(*\index{Input-output streams!floating point format manipulators!precision}*)(*\index{\texttt{cout}!\texttt{setprecision}}*)

// set character text width
cout << setw(10);(*\index{Input-output streams!floating point format manipulators! text width}*)(*\index{\texttt{cout}!\texttt{setw}}*)

// set left or right alignment
cout << left  << 1023.984;(*\index{Input-output streams!floating point format manipulators!left aligned }*)(*\index{\texttt{cout}!\texttt{left}}*)
cout << right << 1023.984;(*\index{Input-output streams!floating point format manipulators!right aligned}*)(*\index{\texttt{cout}!\texttt{right}}*)

// always show decimal point and zeros
cout << showpoint << 0.532;(*\index{Input-output streams!floating point format manipulators!always show decimal point}*)(*\index{\texttt{cout}!\texttt{showpoint}}*)

// always show plus sign
cout << showpos << 3.64;(*\index{Input-output streams!floating point format manipulators!always show plus sign}*)(*\index{\texttt{cout}!\texttt{showpos}}*)
\end{lstlisting}
\begin{enumerate}
...
// is inserted
while ( cin.get(nextChar) )(*\index{\texttt{cin}!\texttt{get}}*)
{
    // process character
}
...
\end{enumerate}
\begin{lstlisting}
try(*\index{\textbf{try-catch}}*)(*\index{Exceptions!\textbf{try-catch}}*)
{
    // check for unexpected input
    char ch;(*\index{\textbf{char}}*)
    if ( cin >> ch && ch != expected_char )(*\index{\texttt{cin}}*)
    {
...
// check the EOF flag
if ( in_stream.eof() )
    cout << "EOF reached!" << endl;(*\index{\texttt{cout}}*)
\end{lstlisting}
\begin{enumerate}
...
string line;(*\index{Strings!\texttt{string}}*)
getline(cin,line);(*\index{\texttt{cin}}*)
\end{lstlisting}
\begin{enumerate}
...
while ( is >> val )
    cout << val << endl;(*\index{\texttt{cout}}*)
\end{lstlisting}
\begin{enumerate}
...
cout << data_stream.str();(*\index{\texttt{cout}}*)
\end{lstlisting}
%
% Vectors
%
...
vector<int> v = {2, 4, 6, 8};(*\index{Vectors!initialised with initialiser list}*)(*\index{Containers!\texttt{vector}}*)(*\index{\textbf{int}}*)

// vector with 10 elements all initialised to 0
vector<int> v(10);(*\index{Vectors!initialised with all elements to 0}*)(*\index{Containers!\texttt{vector}}*)(*\index{\textbf{int}}*)
\end{lstlisting}
\begin{enumerate}
...
cout << v[i];(*\index{Vectors!access to an element!unchecked}*)(*\index{\texttt{cout}}*)

// checked access to the (*i*)th element
cout << v.at(i);(*\index{Vectors!access to an element!checked}*)(*\index{\texttt{cout}}*)(*\index{Containers!\texttt{vector}!\texttt{at}}*)
\end{lstlisting}
\begin{enumerate}
\item[$\Rightarrow$] Add:
\end{enumerate}
...
for (auto x : v)(*\index{Vectors!loop over elements}*)(*\index{\textbf{auto}}*)
  cout << x << endl;(*\index{\texttt{cout}}*)

// (*auto*) gives to (*x*) the same type of the element on the right
// hand side of the assignment, in this case an (*vector::iterator*)
for (auto x = v.begin(); x<v.end(); x++)(*\index{Vectors!loop over elements}*)(*\index{\textbf{auto}}*)
  cout << *x << endl;(*\index{\texttt{cout}}*)
...
\begin{lstlisting}
// size
cout << v.size();(*\index{Vectors!\texttt{size}}*)(*\index{\texttt{cout}}*)(*\index{Containers!\texttt{vector}!\texttt{size}}*)

// capacity: number of elements currently allocated
cout << v.capacity();(*\index{Vectors!\texttt{capacity}}*)(*\index{\texttt{cout}}*)(*\index{Containers!\texttt{vector}!\texttt{capacity}}*)
\end{lstlisting}
\begin{enumerate}
...
vector<int> v = {2, 4, 6, 8};(*\index{Containers!\texttt{vector}}*)(*\index{\textbf{int}}*)

try(*\index{\textbf{try-catch}}*)(*\index{Exceptions!\textbf{try-catch}}*)
{
    cout << v.at(7);(*\index{\texttt{cout}}*)
...
public:
    ...
    explicit MyVector(initializer_list<double>);(*\index{\texttt{initializer\_list}}*)(*\index{\textbf{explicit}}*)(*\index{\textbf{double}}*)
    ...
    MyVector(MyVector&&);
    // copy assignment
    MyVector& operator=(const MyVector&);(*\index{\texttt{operator=}}*)(*\index{\textbf{const}}*)(*\index{\texttt{operator=}}*)
    // move assignment
    ...
    // write
    double& operator[](size_t i) { return e[i]; }(*\index{Classes!subscript operator!write}*)(*\index{\textbf{double}}*)(*\index{\texttt{size\_t}}*)
    // read
    const double& operator[](size_t i) const { return e[i]; };(*\index{Classes!subscript operator!read}*)(*\index{\textbf{const}}*)(*\index{\textbf{double}}*)(*\index{\texttt{size\_t}}*)
    // size
    size_t size() const { return n; }(*\index{Classes!constant member function}*)(*\index{\textbf{const}}*)(*\index{\texttt{size\_t}}*)
    // capacity
    size_t capacity() const { return m; }(*\index{Classes!constant member function}*)(*\index{\textbf{const}}*)(*\index{\texttt{size\_t}}*)
    // reserve
...
MyVector::MyVector(size_t s) : n{s}, m{s}, e{new double[n]}(*\index{\textbf{double}}*)(*\index{\textbf{new}}*)(*\index{\texttt{size\_t}}*)
{
...
\begin{lstlisting}
// copy assignment
MyVector& MyVector::operator=(const MyVector& rv)(*\index{\textbf{const}}*)(*\index{\texttt{operator=}}*)
{
    ...
    // copy the values
    copy(rv.e,rv.e+rv.n,e);(*\index{\texttt{copy}}*)
    n = rv.n;
    return *this;(*\index{\textbf{this}}*)
}
\end{lstlisting}
...
{
    reserve(new_n);
    for (size_t i = n; i < new_n; i++) e[i] = double();(*\index{\textbf{double}}*)(*\index{\texttt{size\_t}}*)
    n = new_n;
}
...
public:
    ...
    // constructor for (*euro*) and (*cents*)
    Euro(int euro, int cents);(*\index{\textbf{int}}*)
    friend Euro operator+(const Euro& amount1, const Euro& amount2);(*\index{\textbf{const}}*)(*\index{\textbf{friend}}*)(*\index{\texttt{operator+}}*)
...
public:
    ...
    Shape& operator=(const Shape&) = delete;(*\index{\textbf{const}}*)(*\index{\texttt{= delete}}*)(*\index{\texttt{operator=}}*)
    // virtual destructor
...
public:
    ...
    pair<Point,Point> get_line() const { return l; }(*\index{\textbf{const}}*)(*\index{\texttt{pair}}*)
...
public:
    ...
    friend ostream& operator<<(ostream& os, const My_exception& e);(*\index{\textbf{const}}*)(*\index{\textbf{friend}}*)(*\index{\texttt{operator<<}}*)
protected:(*\index{\textbf{protected}}*)
    string msg;(*\index{Strings!\texttt{string}}*)
};

try(*\index{Exceptions!\textbf{try-catch}}*)(*\index{\textbf{try-catch}}*)
{
...
public:
    ...
    MyVector(MyVector&&);
    // copy assignment
    MyVector& operator=(const MyVector&);(*\index{\textbf{const}}*)(*\index{\texttt{operator=}}*)
    // move assignment
    ...
    // read
    const T& operator[](size_t i) const { return e[i]; };(*\index{\textbf{const}}*)(*\index{\texttt{size\_t}}*)
    // size
    size_t size() const { return n; }(*\index{\textbf{const}}*)(*\index{\texttt{size\_t}}*)
    // capacity
    size_t capacity() const { return m; }(*\index{\textbf{const}}*)(*\index{\texttt{size\_t}}*)
    // reserve
    void reserve(size_t);(*\index{\texttt{size\_t}}*)
    // resize
    void resize(size_t);(*\index{\texttt{size\_t}}*)
...
// copy assignment
template<class T>(*\index{\textbf{template}}*)
MyVector<T>& MyVector<T>::operator=(const MyVector<T>& rv)(*\index{\textbf{class}!\texttt{MyVector<T>}}*)(*\index{\textbf{const}}*)(*\index{\texttt{operator=}}*)
{
    // check for self assignment
    if (this == &rv)(*\index{\textbf{this}}*)
        return *this;(*\index{\textbf{this}}*)
...
// usage
Wrapper<double,5> array;(*\index{\textbf{double}}*)
Wrapper<char,3> array;(*\index{\textbf{char}}*)
\end{lstlisting}
\begin{enumerate}
...
class A_list(*\index{\textbf{class}!\texttt{A\_list}}*)
{
    ...
    A_list(A_list<T>& b);
    // assignment operator
    A_list<T>& operator=(const A_list<T>& b);(*\index{\textbf{const}}*)(*\index{\texttt{operator=}}*)
    // friend insertion operator
    template <class TT>(*\index{\textbf{template}}*)
    friend ostream& operator<<(ostream& outs, const A_list<TT>& rhs);(*\index{\textbf{const}}*)(*\index{\textbf{friend}}*)(*\index{\texttt{operator<<}}*)
private:
    T *p;
...
vector<int> v = {1,2,3,4,5};(*\index{Containers!\texttt{vector}}*)(*\index{\textbf{int}}*)
// mutable iterator
vector<int>::iterator e;(*\index{\texttt{iterator}}*)(*\index{Iterators!\texttt{iterator}}*)(*\index{\texttt{iterator}}*)(*\index{\textbf{int}}*)

// bidirectional access
e = v.begin();(*\index{\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!bidirectional access}*)
++e;
// print (*v[1]*)
cout << *e << endl;(*\index{\texttt{cout}}*)
--e;
// print (*v[0]*)
cout << *e << endl;(*\index{\texttt{cout}}*)
...
e = v.begin();
// print (*v[3]*)
cout << e[3] << endl;(*\index{\texttt{cout}}*)

// change an element
e[3] = 9;

// constant iterator (only read)
vector<int>::const_iterator c;(*\index{\texttt{const\_iterator}}*)(*\index{Iterators!\texttt{const\_iterator}}*)(*\index{\textbf{int}}*)

// print out the vector content (read only)
// (*\texttt{end()}*) points one element beyond the last one!
for (c = v.begin(); c != v.end(); c++)(*\index{\texttt{iterator}!\texttt{end}}*)
    cout << *c << endl;(*\index{range-for-loop}*)(*\index{\texttt{cout}}*)

// not allowed
// (*c[2] = 2;*)

// reverse iterator
vector<int>::reverse_iterator r;(*\index{\texttt{reverse\_iterator}}*)(*\index{Iterators!\texttt{reverse\_iterator}}*)(*\index{\textbf{int}}*)

// print out the vector content in reverse order
for (r = v.rbegin(); r != v.rend(); r++)(*\index{\texttt{reverse\_iterator}!\texttt{rbegin}}*)(*\index{\texttt{reverse\_iterator}!\texttt{rend}}*)
    cout << *r << endl;(*\index{range-for-loop}*)(*\index{\texttt{cout}}*)
\end{lstlisting}
\begin{enumerate}
...
public:
    ...
    template <class TT>
    friend ostream& operator<<(ostream& outs, const LList<TT>& rhs);(*\index{\textbf{const}}*)(*\index{\textbf{friend}}*)(*\index{\texttt{operator<<}}*)
private:
    // data element
    T data{T()};
    // next pointer
...
public:
    ...
    // assignment operator
    LList<T>& operator=(const LList<T>& rhs);(*\index{\textbf{const}}*)(*\index{\texttt{operator=}}*)
    // virtual destructor
    ...
    friend ostream& operator<<(ostream& outs, const LList<TT>& rhs);(*\index{\textbf{const}}*)(*\index{\textbf{friend}}*)(*\index{\texttt{operator<<}}*)
    // iterator type
    class iterator;(*\index{\texttt{iterator}}*)
...
template <class T>(*\index{\textbf{template}}*)
class LList<T>::iterator(*\index{\texttt{iterator}}*)
{
public:
    ...
    bool operator==(const iterator& b) const { return curr == b.curr; }(*\index{\textbf{const}}*)(*\index{\texttt{operator=}}*)
    bool operator!=(const iterator& b) const { return curr != b.curr; }(*\index{\textbf{const}}*)(*\index{\texttt{operator"!=}}*)
private:
...
// example usage
LList<int> data_list;(*\index{\textbf{int}}*)
...
cout << "data_list = " << data_list << endl;(*\index{\texttt{cout}}*)
// prints  (*data\_list.size() = 3*)
cout << "data_list.size() = " << data_list.size() << "\n\n";(*\index{\texttt{cout}}*)

// applies standard algorithms on the custom linked list
LList<int>::iterator p = find(data_list.begin(),data_list.end(),45);(*\index{\texttt{find}}*)(*\index{\texttt{iterator}}*)(*\index{\textbf{int}}*)
...
list<double> data = {1.32,-2.45,5.65,-8.93,2.76};(*\index{\texttt{list}|see{Containers}}*)(*\index{Containers!\texttt{list}}*)(*\index{\textbf{double}}*)
...
list<double>::iterator e;(*\index{\texttt{iterator}}*)(*\index{\textbf{double}}*)(*\index{Containers!\texttt{list}}*)
...
for (auto x : data)(*\index{range-for-loop}*)
    cout << x << endl;(*\index{\textbf{auto}}*)(*\index{\texttt{cout}}*)
\end{lstlisting}
\begin{enumerate}
...
stack<double> numbers;(*\index{\texttt{stack}|see{Containers}}*)(*\index{Containers!\texttt{stack}}*)(*\index{\textbf{double}}*)
...
// size
cout << numbers.size()(*\index{Containers!\texttt{stack}!\texttt{size}}*)(*\index{\texttt{cout}}*)

// read top data element
double d = numbers.top();(*\index{Containers!\texttt{stack}!\texttt{top}}*)(*\index{\textbf{double}}*)

// pop top element
numbers.pop();(*\index{Containers!\texttt{stack}!\texttt{pop}}*)
\end{lstlisting}
\begin{enumerate}
\item[$\Rightarrow$] Associative containers: \texttt{set}\index{Containers!associative|see{\texttt{set}}}
\end{enumerate}
\begin{lstlisting}
#include <set>(*\index{\texttt{<set>}}*)

set<char> letters;(*\index{\texttt{set}|see{Containers}}*)(*\index{Containers!\texttt{set}}*)(*\index{\textbf{char}}*)
...
// const iterator 
set<char>::const_iterator c;(*\index{\textbf{const}}*)(*\index{\texttt{const\_iterator}}*)(*\index{Containers!\texttt{set}!\texttt{const\_iterator}}*)
for (c = letters.begin(); c != letters.end(); c++)(*\index{\texttt{const\_iterator}!\texttt{begin}}*)(*\index{\texttt{const\_iterator}!\texttt{end}}*)
    cout << *c << endl;(*\index{\texttt{cout}}*)
\end{lstlisting}
\begin{enumerate}
\item[$\Rightarrow$] Associative containers: \texttt{map}\index{Containers!associative|see{\texttt{map}}}
\end{enumerate}
\begin{lstlisting}
#include <string>(*\index{\texttt{<string>}}*)
...
// initialisation
map<string,int> dict = { {"one",1}, {"two",2} };(*\index{\texttt{map}|see{Containers}}*)(*\index{\textbf{int}}*)(*\index{Containers!\texttt{map}}*)(*\index{Strings!\texttt{string}}*)
pair<string,int> three("three",3);(*\index{\texttt{pair}}*)(*\index{\textbf{int}}*)(*\index{Strings!\texttt{string}}*)
...
// iterator    
map<string,int>::iterator two;(*\index{\texttt{iterator}}*)(*\index{\textbf{int}}*)(*\index{Strings!\texttt{string}}*)
...
for (auto n : dict)(*\index{\textbf{auto}}*)
    cout << "(" <<  n.first << "," <<  n.second << ")" << endl;(*\index{\texttt{cout}}*)
\end{lstlisting}
%
% Algorithms
%
...
vector<int> v = {6,2,7,13,4,3,1};(*\index{\texttt{vector}|see{Containers}}*)(*\index{\texttt{vector}|see{Vectors}}*)(*\index{Containers!\texttt{vector}}*)(*\index{\textbf{int}}*)
vector<int>::iterator p;(*\index{\texttt{iterator}}*)(*\index{\textbf{int}}*)

// (*find*)(*\index{Algorithms!\texttt{find}}*)
// points to the first occurrence of 13 in (*v*)
p = find(v.begin(),v.end(),13);(*\index{\texttt{find}}*)
...
p = find_if(v.begin(),v.end(),test_greater_than_5);(*\index{\texttt{find\_if}}*)
...
p = find_if(v.begin(),v.end(),Test_greater(7));(*\index{\texttt{find\_if}}*)
...
double res = accumulate(v.begin(),v.end(),1.0,multiplies<int>());(*\index{\textbf{double}}*)(*\index{\textbf{int}}*)

// (*inner product*)
vector<int> v1 = {-2,2,4,11,-4,3,1};(*\index{Containers!\texttt{vector}}*)(*\index{\textbf{int}}*)
vector<int> v2 = {4,2,4,18,5,3,1,7,9,};(*\index{Containers!\texttt{vector}}*)(*\index{\textbf{int}}*)

long res = inner_product(v1.begin(), v1.end(), v2.begin(),long(0));(*\index{Algorithms!\texttt{inner\_product}}*)(*\index{\textbf{long}}*)

// merge sort
sort(v.begin(),v.end());(*\index{Algorithms!\texttt{sort}}*)

// binary search
bool found;
found = binary_search(v.begin(), v.end(), 3);(*\index{Algorithms!\texttt{binary\_search}}*)

// reverse
reverse(v.begin(),v.end());(*\index{Algorithms!\texttt{reverse}}*)
\end{lstlisting}
%
% Bibliography
%
