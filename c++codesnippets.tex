...
for (auto x = v.begin(); x<v.end(); x++)(*\index{Vectors!loop over elements}*)(*\index{\textbf{auto}}*)(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{iterator}!\texttt{end}}*)(*\index{Containers!\texttt{vector}!\texttt{iterator}}*)
  cout << *x << endl;(*\index{Input-output streams!\texttt{cout}}*)
...
// mutable iterator
vector<int>::iterator e;(*\index{Iterators!\texttt{iterator}}*)(*\index{\texttt{iterator}|see{Iterators}}*)(*\index{Containers!\texttt{vector}!\texttt{iterator}}*)

// bidirectional access
e = v.begin();(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!bidirectional access}*)(*\index{Containers!\texttt{vector}!\texttt{iterator}}*)
++e;
// print (*v[1]*)
...
e = v.begin();(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Containers!\texttt{vector}!\texttt{iterator}}*)
// print (*v[3]*)
...
vector<int>::const_iterator c;(*\index{\texttt{const\_iterator}|see{Iterators}}*)(*\index{Iterators!\texttt{const\_iterator}}*)(*\index{Containers!\texttt{vector}!\texttt{const\_iterator}}*)

// print out the vector content (read only)
// (*\texttt{end()}*) points one element beyond the last one!
for (c = v.begin(); c != v.end(); c++)(*\index{Iterators!\texttt{const\_iterator}!\texttt{end}}*)(*\index{Iterators!\texttt{const\_iterator}!\texttt{begin}}*)
...
// reverse iterator
vector<int>::reverse_iterator r;(*\index{\texttt{reverse\_iterator}|see{Iterators}}*)(*\index{Iterators!\texttt{reverse\_iterator}}*)(*\index{Containers!\texttt{vector}!\texttt{reverse\_iterator}}*)

// print out the vector content in reverse order
for (r = v.rbegin(); r != v.rend(); r++)(*\index{Iterators!\texttt{reverse\_iterator}!\texttt{rbegin}}*)(*\index{Iterators!\texttt{reverse\_iterator}!\texttt{rend}}*)
...
LList<int>::iterator p = find(data_list.begin(),data_list.end(),45);(*\index{\texttt{find}|see{Algorithms}}*)(*\index{Algorithms!\texttt{find}}*)
(*\index{Iterators!\texttt{LList<T>}!\texttt{iterator}}*)(*\index{Iterators!\texttt{LList<T>}!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{LList<T>}!\texttt{iterator}!\texttt{end}}*)
...
list<double>::iterator e;(*\index{Iterators!\texttt{iterator}}*)(*\index{Containers!\texttt{list}}*)(*\index{Containers!\texttt{list}!\texttt{iterator}}*)

// (*advance*)
e = data.begin();(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)
...
for (e = data.begin(); e != data.end(); e++)(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{iterator}!\texttt{end}}*)
    cout << *e << endl;(*\index{Input-output streams!\texttt{cout}}*)
...
// const iterator 
set<char>::const_iterator c;(*\index{Constants!\textbf{const}}*)(*\index{Iterators!\texttt{const\_iterator}}*)(*\index{Containers!\texttt{set}!\texttt{const\_iterator}}*)
for (c = letters.begin(); c != letters.end(); c++)(*\index{Iterators!\texttt{const\_iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{const\_iterator}!\texttt{end}}*)
...
// iterator    
map<string,int>::iterator two;(*\index{Iterators!\texttt{iterator}}*)(*\index{Strings!\texttt{string}}*)(*\index{Containers!\texttt{map}!\texttt{iterator}}*)
...
vector<int> v = {6,2,7,13,4,3,1};(*\index{\texttt{vector}|see{Containers}}*)(*\index{\texttt{vector}|see{Vectors}}*)(*\index{Containers!\texttt{vector}}*)
vector<int>::iterator p;(*\index{Iterators!\texttt{iterator}}*)

// (*find*)(*\index{Algorithms!\texttt{find}}*)
// points to the first occurrence of 13 in (*v*)
p = find(v.begin(),v.end(),13);(*\index{Algorithms!\texttt{find}}*)(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{iterator}!\texttt{end}}*)
...
p = find_if(v.begin(),v.end(),test_greater_than_5);(*\index{Algorithms!\texttt{find\_if}}*)(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{iterator}!\texttt{end}}*)
...
p = find_if(v.begin(),v.end(),Test_greater(7));(*\index{Algorithms!\texttt{find\_if}}*)(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{iterator}!\texttt{end}}*)

// (*accumulate*)
// adds the values from a sequence
// the last parameter is the initial value
// the return type is the type of the initial value!
long res = accumulate(v.begin(),v.end(),long(0));(*\index{Algorithms!\texttt{accumulate}}*)(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{iterator}!\texttt{end}}*)
...
double res = accumulate(v.begin(),v.end(),1.0,multiplies<int>());(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{iterator}!\texttt{end}}*)

// (*inner product*)
vector<int> v1 = {-2,2,4,11,-4,3,1};(*\index{Containers!\texttt{vector}}*)
vector<int> v2 = {4,2,4,18,5,3,1,7,9,};(*\index{Containers!\texttt{vector}}*)

long res = inner_product(v1.begin(), v1.end(), v2.begin(),long(0));(*\index{Algorithms!\texttt{inner\_product}}*)(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{iterator}!\texttt{end}}*)
...
// reverse
reverse(v.begin(),v.end());(*\index{Algorithms!\texttt{reverse}}*)(*\index{Iterators!\texttt{iterator}!\texttt{begin}}*)(*\index{Iterators!\texttt{iterator}!\texttt{end}}*)
\end{lstlisting}
%
% Bibliography
%
