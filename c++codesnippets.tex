...
\date{\small \today~-~Version 1.97~-~GNU GPL v3.0}
...
\end{lstlisting}
\begin{enumerate}
\item[] Accessing the current folder:
\end{enumerate}
\begin{lstlisting}    
...
\end{lstlisting}
\begin{enumerate}
\item[] Directory iterator:
\end{enumerate}
\begin{lstlisting}    
// directory iterator
directory_iterator dir{current_dir};(*\index{\texttt{cdirectory\_iterator}}*)(*\index{Utilities!Filesystem!directory iterator}*)
\end{lstlisting}
\begin{enumerate}
...
for (auto& dir_entry : dir) {
    if ( dir_entry.is_directory() )
        cout << "Found directory: " << dir_entry.path().filename() << endl;
    else if ( dir_entry.is_regular_file() ) {
        cout << "Found a file: " << dir_entry.path().filename() << ", ";
