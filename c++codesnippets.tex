...
\small
\begin{enumerate}
\item[$\Rightarrow$] \texttt{using}\index{\textbf{using}} declarations for avoiding fully qualified names:
...
\end{lstlisting}
\begin{enumerate}
\item[$\Rightarrow$] \texttt{using namespace}\index{\textbf{namespace}} directives for including the whole namespace:
