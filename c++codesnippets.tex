...
\date{\small \today~-~Version 1.83~-~GNU GPL v3.0}
...
\begin{lstlisting}
// internal linkage
static void sum(void);(*\index{\textbf{static}|see{Modifiers}}*)
...
constexpr int sum(int a, int b) { return a+b; }(*\index{\textbf{constexpr}|see{Modifiers}} *)
\end{lstlisting}
\begin{enumerate}
...
public:
    ...
    virtual int price(void) final {(*\index{\texttt{final}}*)
       // ...
    }
};
...
public:
    ...
    // a virtual function
    int price(void) override {} // compiler error!{(*\index{\texttt{override}}*)
};

// a (*final*) class doesn't allow derived classes
class Fruit final{(*\index{\texttt{final}}*)
{
public:
...
int sum(int a, int b) noexcept { return a+b; }(*\index{ \textbf{noexcept}}*)
\end{lstlisting}
%
% Operators
%
