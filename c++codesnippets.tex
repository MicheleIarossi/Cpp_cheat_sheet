...
void func(void)
{
    cout<< "Start of func()" << endl;(*\index{Input-output streams!\texttt{cout}}*)
    
    // static storage, local variable
    static Object c{"c"};
    
    cout<< "End of func()" << endl;(*\index{Input-output streams!\texttt{cout}}*)
}

int main()
{
    cout<< "Start of main()" << endl;(*\index{Input-output streams!\texttt{cout}}*)
    
    func();
    
    // local scope
    {
        cout<< "Start of local scope" << endl;(*\index{Input-output streams!\texttt{cout}}*)
        
        // automatic storage object
        Object d{"d"};
        
        cout<< "End of local scope" << endl;(*\index{Input-output streams!\texttt{cout}}*)
    }
    ...
    cout<< "End of main()" << endl;(*\index{Input-output streams!\texttt{cout}}*)
    return 0;
}
\end{lstlisting}
\begin{enumerate}
...
\end{lstlisting}
\begin{enumerate}
\item[$\Rightarrow$] Uniform container for callable objects:\index{Functions!uniform container}
\end{enumerate}
\begin{lstlisting}
