...
\date{\small \today~-~Version 2.00~-~GNU GPL v3.0}
...
// any thread accessing (*counter*) gets its own copy of the variable
...
int sleeping_thread(int n) {
    cout << "Sleeping thread #" << n << " started..." << endl;
    // pause thread for 5s
...
int incrementing_thread(int n) {
    ...
    while (1) {
        ...
        // got the mutex
        // check current counter value and exit if necessary
        if (counter >= n)
            break;
    ...
    cout << "incrementing_thread<" << c << ">(): done" << endl;
...
int atomic_incrementing_thread(int n) {
    while (1) {
        cout << "atomic_incrementing_thread<" << c << ">(): " 
    ...
    cout << "atomic_incrementing_thread<" << c << ">(): done" << endl;
...
\bibitem{cppreference} \textsl{C++ reference} [https://en.cppreference.com]
\bibitem{cplusplus} \textsl{cplusplus} [https://cplusplus.com/]
\end{thebibliography}
%
% Index
%
