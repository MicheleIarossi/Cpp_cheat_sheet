...
\date{\small \today~-~Version 1.80~-~GNU GPL v3.0}
...
public:
    ...
    Basic& operator=(const Basic& b) = default;(*\index{\texttt{= default}}*)
...
public:
    ...
    // no copy assignment
    Basic& operator=(const Basic& b) = delete;(*\index{\texttt{= delete}}*)
     // no move constructor
    Basic(const Basic&& b) = delete;(*\index{\texttt{= delete}}*)
     // no move assignment
    Basic& operator=(const Basic&& b) = delete; (*\index{\texttt{= delete}}*)
