...
\date{\small \today~-~Version 1.88~-~GNU GPL v3.0}
...
\begin{lstlisting}
// size
cout << v.size();(*\index{Vectors!\texttt{size}}*)(*\index{Containers!\texttt{vector}!\texttt{size}}*)

// capacity: number of elements currently allocated
cout << v.capacity();(*\index{Vectors!\texttt{capacity}}*)(*\index{Containers!\texttt{vector}!\texttt{capacity}}*)
\end{lstlisting}
\begin{enumerate}
...
\end{lstlisting}
\begin{enumerate}
\item[$\Rightarrow$] Bitsets
\index{range-for-loop}
\end{enumerate}
\begin{enumerate}
\item[] Bits and bit operations:\index{Utilities!Bitsets!bits and bit operations}
\index{range-for-loop}
\end{enumerate}
\begin{lstlisting}
...
\end{lstlisting}
\begin{enumerate}
\item[] Access to single bits:\index{Utilities!Bitsets!access to single bits}
\index{range-for-loop}
\end{enumerate}
\begin{lstlisting}
...
\end{enumerate}
\begin{enumerate}
\item[] Run-time measurement in milliseconds\index{Run-time measurement|see{Utilities!Chrono}}
\end{enumerate}
\begin{lstlisting}
