...
using namespace std;(*\index{\texttt{std}}*) 
\end{lstlisting}
...
public:
    ...
    explicit MyVector(initializer_list<double>);(*\index{\texttt{initializer\_list}}*)
    ...
    MyVector(MyVector&&);
    // copy assignment
    MyVector& operator=(const MyVector&);(*\index{\texttt{operator=}}*)
    // move assignment
...
public:
    ...
    Euro operator+(const Euro& amount); (*\index{\texttt{operator+}}*)
private:
    int euro;
    int cents;
};
...
public:
    ...
    friend ostream& operator<<(ostream& outs, const Euro& amount);(*\index{\texttt{operator<<}}*)(*\index{\textbf{friend}}*)
    friend istream& operator>>(istream& ins, Euro& amount);(*\index{\texttt{operator>>}}*)
private:
    int euro;
    int cents;
};
...
protected:
    ...
    virtual void move_shape(int dx, int dy) = 0;(*\index{\texttt{= 0}}*)
    ...
};
\end{lstlisting}
\begin{enumerate}
...
double d = numbers.top();(*\index{Containers!\texttt{top}}*)
