...
\date{\small \today~-~Version 1.93~-~GNU GPL v3.0}
...
\section{Strings}
\small
Strings as supported by the C++ standard library for ASCII character sets.
\begin{enumerate}
...
\end{lstlisting}
\begin{enumerate}
\item[$\Rightarrow$] Literal constructor:
\end{enumerate}
\begin{lstlisting}
using namespace string_literals;(*\index{\texttt{string\_literals}}*)(*\index{Namespaces!\textbf{using namespace} directives}*)(*\index{\textbf{namespace}|see{Namespaces}}*)

// incorporates zeros
string s8 = "hellohello\0\0hello"s;(*\index{Strings!\texttt{string}}*)(*\index{Strings!literal constructor}*)
\end{lstlisting}
\begin{enumerate}
\item[$\Rightarrow$] Read a line:
\end{enumerate}
...
using namespace std::chrono;(*\index{\texttt{chrono}}*)(*\index{Namespaces!\textbf{using namespace} directives}*)(*\index{\textbf{namespace}|see{Namespaces}}*)
using namespace std::literals::chrono_literals;(*\index{\texttt{chrono\_literals}}*)(*\index{Namespaces!\textbf{using namespace} directives}*)(*\index{\textbf{namespace}|see{Namespaces}}*)
