...
\date{\small \today~-~Version 1.55~-~GNU GPL v3.0}
...
\small
\begin{enumerate}
\item[$\Rightarrow$] Use \textbf{static\_cast} for normal casting\index{Casts!\textbf{static\_cast}}\index{\textbf{static\_cast}}, i.e. types that can be converted into each other:
\end{enumerate}
\begin{lstlisting}
...
\end{lstlisting}
\begin{enumerate}
\item[$\Rightarrow$] Use \textbf{reinterpret\_cast} for casting between unrelated pointer types\index{Casts!\textbf{reinterpret\_cast}}\index{\textbf{reinterpret\_cast}}:
\end{enumerate}
\begin{lstlisting}
...
for (auto c = v.begin(); c != v.end(); c++)(*\index{\textbf{iterator}!end}*)
...
for (auto r = v.rbegin(); r != v.rend(); r++)(*\index{\textbf{reverse\_iterator}!rbegin}*)(*\index{\textbf{reverse\_iterator}!rend}*)
