...
\date{\small \today~-~Version 1.58~-~GNU GPL v3.0}
...
\end{enumerate}
\begin{lstlisting}
constexpr int max = 200;(*\index{\textbf{constexpr}|see{Constants}} *)(*\index{Constants!\textbf{constexpr}}*)(*\index{\textbf{int}}*)
constexpr int c = max + 2;(*\index{Constants!\textbf{constexpr}}*)(*\index{\textbf{int}}*)
\end{lstlisting}
\begin{enumerate}
...
const int m = n + 1;(*\index{\textbf{const}|see{Constants}}*)(*\index{Constants!\textbf{const}}*)(*\index{\textbf{int}}*)
\end{lstlisting}
%
% Type casting
%
...
// back to (*double*) type
double *pd = static_cast<double*>(p);(*\index{\textbf{double}}*)(*\index{\textbf{static\_cast}|see{Casts}}*)
\end{lstlisting}
\begin{enumerate}
...
double *pd = reinterpret_cast<double *>(&n);(*\index{\textbf{double}}*)(*\index{\textbf{reinterpret\_cast}|see{Casts}}*)
...
void set_birthday(const int& day, int& month, int year);(*\index{Constants!\textbf{const}}*)(*\index{\textbf{int}}*)
\end{lstlisting}
\begin{enumerate}
...
using pchar = char*; // (*pchar*) means (*char$\ast$*)(*\index{\textbf{char}}*)\index{Alias!{\textbf{using}}}
\end{lstlisting}
%
% Random numbers
%
...
const int SIZE = 10 + 1;(*\index{Constants!\textbf{const}}*)(*\index{\textbf{int}}*)
...
public:
    ...
    // read
    const double& operator[](size_t i) const { return e[i]; };(*\index{Classes!subscript operator!read}*)(*\index{Constants!\textbf{const}}*)(*\index{\textbf{double}}*)(*\index{\texttt{size\_t}}*)
    // size
...
public:
    ...
    int get_radius() const { return r; }(*\index{Constants!\textbf{const}}*)(*\index{\textbf{int}}*)
...
// copy assignment
template<class T>(*\index{Templates!\textbf{template}}*)
MyVector<T>& MyVector<T>::operator=(const MyVector<T>& rv)(*\index{\textbf{class}!\texttt{MyVector<T>}}*)(*\index{Constants!\textbf{const}}*)(*\index{\texttt{operator=}}*)
{
    // check for self assignment
    if (this == &rv)(*\index{\textbf{this}}*)
        return *this;(*\index{\textbf{this}}*)
...
public:
    ...
    const T& operator[](int n) const { return v[n]; };(*\index{Constants!\textbf{const}}*)(*\index{\textbf{int}}*)
    size_t size() const { return N; }(*\index{Constants!\textbf{const}}*)(*\index{\texttt{size\_t}}*)
private:
    T v[N];
};
...
// const iterator 
set<char>::const_iterator c;(*\index{Constants!\textbf{const}}*)(*\index{\texttt{const\_iterator}}*)(*\index{Containers!\texttt{set}!\texttt{const\_iterator}}*)
...
public:
    ...
    bool operator() (const int x) const { return x>n; }(*\index{Constants!\textbf{const}}*)(*\index{\textbf{int}}*)
private:
