...
\date{\small \today~-~Version 1.42~-~GNU GPL v3.0}
...
catch (runtime_error e)
{
    ...
    if (cin.fail())
    {
        // clear failed bit(*\index{Input-output streams!handling of unexpected input!clearing the failed state of the input streamt}*)
        cin.clear();
