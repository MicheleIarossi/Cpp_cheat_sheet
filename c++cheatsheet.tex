...
\index{\#include <iostream>!Standard input-output library}
\begin{lstlisting}
#include <iostream> (*\index{\#include <iostream>}*)
...
\small
\begin{enumerate}
\item[$\Rightarrow$] Use \textbf{static\_cast} for normal casting\index{Casts!\textbf{static\_cast}}:
\end{enumerate}
\begin{lstlisting}
...
\index{\#include <iostream>!Input-output streams}
\small
\begin{enumerate}
